...
#         print(features.shape, rois.shape, spatial_scale, pooled_height, pooled_width, sampling_ratio)
        return torchvision.ops.roi_align(
            features, rois, (pooled_height, pooled_width), spatial_scale, sampling_ratio)
